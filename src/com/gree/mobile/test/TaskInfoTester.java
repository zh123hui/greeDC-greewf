...
public class TaskInfoTester extends TestCase{
	...
	public void test() throws Exception{
		DefaultXmlFileLoader loader = new DefaultXmlFileLoader();
		TaskInfoNode load = loader.load(new File("F:/zh-private/gree/workspace/origin-gm/webroot/config/test_docInfo_config.xml"));
